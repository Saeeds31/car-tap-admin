  ...
  <div class="container py-4">
    <b-card>
      ...
      <b-form @submit.prevent="handleSubmit">
        <b-row>
          ...
          <b-col cols="12" md="6">
            <b-form-group label="نسبت" label-for="ratio">
              <b-form-input id="ratio" v-model="form.ratio" :state="errors.ratio ? false : null"
        ...
        <div class="mt-3">
          <b-button v-if="checkPermission(['banner_update'])" type="submit"
          :disabled="loader"
          variant="primary">ویرایش بنر</b-button>
        </div>
      </b-form>
    </b-card>
  </div>
...
let positions = [
  { id: 'intro', label: "بخش معرفی مجموعه" },
  { id: 'whatwedo', label: "چه کاری انجام می دهیم" },
];
let oldImage = ref([])
let oldImage1 = ref([])
